...
const experiences = [
  {
    ...
    list: [
      "Élaboration de script Prehome / Bandeaux.",
      "Création d'E-commerce sur des plateformes telles que Prestashop et Wix.",
      "Intégration de maquettes de Landing Page.",
      "Réalisation d'Email pour des campagnes telles que newsletters et publicités.",
    ],
  ...
  },
  {
    ...
    list: [
      ...
      "Intégration des maquettes en mettant l'accent sur l'expérience utilisateur.",
      "Vérification de la qualité des développements et des intégrations.",
      "Développement de nouvelles fonctionnalités et suivi de bugs.",
      "Estimation des tâches dans le cadre d'un projet en agilité.",
    ],
  ...
  },
  {
    ...
    list: [
      "Optimisation d'interface de borne pour la rendre responsive.",
      "Intégration finale du site de présentation du Creative Studio.",
      "Élaboration d'un design system marque blanche pour accélérer la création de design system.",
      "Réalisation d'audit d'accessibilité RGAA sur des sites gouvernementaux.",
    ],
...
const educations = [
  {
    ...
    list: [
      "Simulation de réponse à un appel d’offre (Fintech, Healthtech).",
      "Développement et gestion de projets web.",
      "Mise en situation d’une transformation digital (Retail, Fintech, Healthtech).",
      "Accompagnement des changements humains d’une organisation.",
      "Développement et gestion d'un projet web de planification de voyage, d'un projet de partage d'itinéraires de randonnée, et d'un projet de dashboard sur la cryptomonnaie.",
      "Initiation à l’IA (Gymnasium, Q-learning).",
    ],
  ...
  },
  {
    ...
    list: [
      "Projets mathématiques en python.",
      "Réalisation d'un dashboard en React JS.",
      "Initiation Devops (Jenkis, Docker).",
      "Initiation développement mobile (Flutter).",
      "Anglais Tepitech 860 (TOEIC Epitech).",
      "Simulation de lancement d'une start up.",
    ],
